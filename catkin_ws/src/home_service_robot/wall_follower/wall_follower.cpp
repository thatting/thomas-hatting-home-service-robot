...
int main(int argc, char** argv)
{
    ...
    ros::init(argc, argv, "wall_follower");   //Node name changed to wall_follower
    ...
    motor_command_publisher = n.advertise<geometry_msgs::Twist>("/mobile_base/commands/velocity", 100);     //topic changed to /mobile_base/commands/velocity

    // Subscribe to the /scan topic and call the laser_callback function
    laser_subscriber = n.subscribe("/scan", 1000, laser_callback);     //topic changed to /scan
